...
import { fridayPairs, mondayPairs, saturdayPairs, thursdayPairs, tuesdayPairs, wednesdayPairs, } from "../constraints/collegeTable";
    ...
    getGroupColumn(groupName) {
        ...
        for (let r = range.s.r; r <= range.e.r; r++) {
            for (let c = range.s.c; c <= range.e.c; c++) {
                ...
                if (!this.sheet[cell])
                    continue;
                if (this.sheet[cell].w.toLowerCase().split(" ")[0].replace(/\s/g, "") ===
...
//# sourceMappingURL=CollegeParser.js.map